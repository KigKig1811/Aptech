...
public class FollowSB implements FollowSBLocal {
    @PersistenceContext(unitName = "ProjectWSPU")
    private EntityManager em;
    

    @Override
    public List<entities.Follow> findAll() {
    ...
    @Override
    public boolean Follow(Integer userId, Integer seLLId, Integer modeId, Integer cateId, String header, String content, 
                            double price, String address, String street, String district, String ward, String cityProvince,
                            double area, String photothumbnail, Date dateUp, Date expDate, Integer agentId, String agentAcount,
                            String sellAcount, boolean approved, boolean paid, int bedroom) {
