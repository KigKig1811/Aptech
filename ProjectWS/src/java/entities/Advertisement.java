...
public class Advertisement implements Serializable {
    ...
    @OneToMany(mappedBy = "advId")
    private List<LastedNews> lastedNewsList;
    ...
    @XmlTransient
    public List<LastedNews> getLastedNewsList() {
        return lastedNewsList;
    }

    public void setLastedNewsList(List<LastedNews> lastedNewsList) {
        this.lastedNewsList = lastedNewsList;
    }
